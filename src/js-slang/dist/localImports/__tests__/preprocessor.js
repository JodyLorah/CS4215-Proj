...
describe('getImportedLocalModulePaths', () => {
    let context = context_1.mockContext(types_1.Chapter.LIBRARY_PARSER);
    beforeEach(() => {
        context = context_1.mockContext(types_1.Chapter.LIBRARY_PARSER);
    });
    const assertCorrectModulePathsAreReturned = (code, baseFilePath, expectedModulePaths) => {
        ...
        expect(preprocessor_1.getImportedLocalModulePaths(program, baseFilePath)).toEqual(new Set(expectedModulePaths));
    };
    it('throws an error if the current file path is not absolute', () => {
        ...
        expect(() => preprocessor_1.getImportedLocalModulePaths(program, 'a.js')).toThrowError("Current file path 'a.js' is not absolute.");
    });
...
describe('preprocessFileImports', () => {
    ...
    it('returns undefined if the entrypoint file does not exist', () => {
        ...
        const actualProgram = preprocessor_1.default(files, '/non-existent-file.js', actualContext);
    ...
    it('returns the same AST if the entrypoint file does not contain import/export statements', () => {
      ...
      `
        ...
        const actualProgram = preprocessor_1.default(files, '/a.js', actualContext);
    ...
    it('returns CircularImportError if there are circular imports', () => {
      ...
      `
        ...
        preprocessor_1.default(files, '/a.js', actualContext);
        expect(index_1.parseError(actualContext.errors)).toMatchInlineSnapshot(`"Circular import detected: '/a.js' -> '/b.js' -> '/c.js' -> '/a.js'."`);
    });
    it('returns CircularImportError if there are circular imports - verbose', () => {
      ...
      `
        ...
        preprocessor_1.default(files, '/a.js', actualContext);
        expect(index_1.parseError(actualContext.errors, true)).toMatchInlineSnapshot(`
    ...
    it('returns CircularImportError if there are self-imports', () => {
      ...
      `
        ...
        preprocessor_1.default(files, '/a.js', actualContext);
        expect(index_1.parseError(actualContext.errors)).toMatchInlineSnapshot(`"Circular import detected: '/a.js' -> '/a.js'."`);
    });
