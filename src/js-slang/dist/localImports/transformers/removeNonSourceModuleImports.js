 ...
 */
exports.isSourceModule = (moduleName) => {
    return !filePaths_1.isFilePath(moduleName);
};
/**
 ...
 */
exports.removeNonSourceModuleImports = (program) => {
    ...
    walkers_1.ancestor(program, {
        ImportDeclaration(node, _state, ancestors) {
            ...
            if (!exports.isSourceModule(node.source.value)) {
                removeImportDeclaration(node, ancestors);
            }
        }
    });
