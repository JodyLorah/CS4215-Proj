 ...
 */
exports.hoistAndMergeImports = (program) => {
    var _a;
    ...
    const nonImportDeclarations = program.body.filter((node) => !typeGuards_1.isImportDeclaration(node));
    ...
    for (const importDeclaration of importDeclarations) {
        ...
        for (const specifier of importDeclaration.specifiers) {
            ...
            const strippedSpecifier = contextSpecificConstructors_1.cloneAndStripImportSpecifier(specifier);
    ...
    importSourceToSpecifiersMap.forEach((specifiers, importSource) => {
        mergedImportDeclarations.push(baseConstructors_1.createImportDeclaration(specifiers, baseConstructors_1.createLiteral(importSource)));
    });
