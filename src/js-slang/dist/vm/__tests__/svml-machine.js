...
describe('standard opcodes', () => {
    test('LGCI works', () => {
        return testing_1.expectDisplayResult(`display(123);`, {
    ...
    test('LGCF64 works', () => {
        return testing_1.expectDisplayResult(`display(1.5);`, {
            chapter: types_1.Chapter.SOURCE_3,
            variant: types_1.Variant.CONCURRENT
        }).toMatchInlineSnapshot(`
              Array [
    ...
    test('LGCB0 works', () => {
        return testing_1.expectDisplayResult(`display(false);`, {
            chapter: types_1.Chapter.SOURCE_3,
            variant: types_1.Variant.CONCURRENT
        }).toMatchInlineSnapshot(`
              Array [
    ...
    test('LGCB1 works', () => {
        return testing_1.expectDisplayResult(`display(true);`, {
            chapter: types_1.Chapter.SOURCE_3,
            variant: types_1.Variant.CONCURRENT
        }).toMatchInlineSnapshot(`
              Array [
    ...
    test('LGCU works', () => {
        return testing_1.expectDisplayResult(`display(undefined);`, {
            chapter: types_1.Chapter.SOURCE_3,
            variant: types_1.Variant.CONCURRENT
        }).toMatchInlineSnapshot(`
              Array [
    ...
    test('LGCN works', () => {
        return testing_1.expectDisplayResult(`display(null);`, {
            chapter: types_1.Chapter.SOURCE_3,
            variant: types_1.Variant.CONCURRENT
        }).toMatchInlineSnapshot(`
              Array [
    ...
    test('LGCS works', () => {
        return testing_1.expectDisplayResult(`display("test string");`, {
            chapter: types_1.Chapter.SOURCE_3,
            variant: types_1.Variant.CONCURRENT
        }).toMatchInlineSnapshot(`
              Array [
    ...
    test('ADDG works for numbers', () => {
        return testing_1.expectDisplayResult('display(-1+1);', {
            chapter: types_1.Chapter.SOURCE_3,
            variant: types_1.Variant.CONCURRENT
        }).toMatchInlineSnapshot(`
              Array [
    ...
    test('ADDG works for strings', () => {
        return testing_1.expectDisplayResult('display("first"+"second");', {
            chapter: types_1.Chapter.SOURCE_3,
            variant: types_1.Variant.CONCURRENT
        }).toMatchInlineSnapshot(`
              Array [
    ...
    test('SUBG works for numbers', () => {
        return testing_1.expectDisplayResult('display(123-124);', {
            chapter: types_1.Chapter.SOURCE_3,
            variant: types_1.Variant.CONCURRENT
        }).toMatchInlineSnapshot(`
              Array [
    ...
    test('MULG works for numbers', () => {
        return testing_1.expectDisplayResult('display(123*2);', {
            chapter: types_1.Chapter.SOURCE_3,
            variant: types_1.Variant.CONCURRENT
        }).toMatchInlineSnapshot(`
              Array [
    ...
    test('DIVG works for numbers', () => {
        return testing_1.expectDisplayResult('display(128/32);', {
            chapter: types_1.Chapter.SOURCE_3,
            variant: types_1.Variant.CONCURRENT
        }).toMatchInlineSnapshot(`
              Array [
    ...
    test('DIVG fails for division by 0', () => {
        return testing_1.expectParsedError('128/0;', {
            chapter: types_1.Chapter.SOURCE_3,
            variant: types_1.Variant.CONCURRENT
    ...
    test('MODG works for numbers', () => {
        return testing_1.expectDisplayResult('display(128%31);', {
            chapter: types_1.Chapter.SOURCE_3,
            variant: types_1.Variant.CONCURRENT
        }).toMatchInlineSnapshot(`
              Array [
    ...
    test('STLG and LDLG works', () => {
        return testing_1.expectDisplayResult(`const x = 1; display(x);`, {
            chapter: types_1.Chapter.SOURCE_3,
            variant: types_1.Variant.CONCURRENT
        }).toMatchInlineSnapshot(`
              Array [
...
describe('primitive opcodes', () => {
    ...
    test('nullary handler', () => {
        return testing_1.snapshotSuccess('get_time();', {
            chapter: types_1.Chapter.SOURCE_3,
            variant: types_1.Variant.CONCURRENT
        });
    });
...
describe('standard program execution', () => {
    test('program always returns all threads terminated', () => {
        return testing_1.expectResult('1 + 1;', { chapter: types_1.Chapter.SOURCE_3, variant: types_1.Variant.CONCURRENT }).toBe('all threads terminated');
    });
    ...
    test('program times out', () => {
        return testing_1.expectParsedError('while(true) {}', {
            chapter: types_1.Chapter.SOURCE_3,
            variant: types_1.Variant.CONCURRENT
        }).toMatchInlineSnapshot(`
...
test('concurrent program execution interleaves', () => {
  ...
  `;
    return testing_1.getDisplayResult(code, { chapter: types_1.Chapter.SOURCE_3, variant: types_1.Variant.CONCURRENT }).then(displayResult => {
...
test('concurrent program execution interleaves (busy wait)', () => {
  ...
  `;
    return testing_1.getDisplayResult(code, { chapter: types_1.Chapter.SOURCE_3, variant: types_1.Variant.CONCURRENT });
});
