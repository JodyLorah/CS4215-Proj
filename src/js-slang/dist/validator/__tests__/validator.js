...
function toValidatedAst(code) {
    const context = context_1.mockContext(types_1.Chapter.SOURCE_1);
...
test('for loop variable cannot be reassigned', () => __awaiter(void 0, void 0, void 0, function* () {
  ...
  `;
    return testing_1.expectParsedError(code, { chapter: types_1.Chapter.SOURCE_4 }).toMatchInlineSnapshot(`"Line 2: Assignment to a for loop variable in the for loop is not allowed."`);
}));
test('for loop variable cannot be reassigned in closure', () => __awaiter(void 0, void 0, void 0, function* () {
  ...
  `;
    return testing_1.expectParsedError(code, { chapter: types_1.Chapter.SOURCE_4 }).toMatchInlineSnapshot(`"Line 3: Assignment to a for loop variable in the for loop is not allowed."`);
}));
