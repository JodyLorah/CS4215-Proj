...
function toSourceError(error, sourceMap) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (errorMessageContains(ASSIGNMENT_TO_CONST_ERROR_MESSAGES)) {
            return new errors_1.ConstAssignment(astCreator_1.locationDummyNode(line, column, source), identifier);
        }
        else if (errorMessageContains(UNDEFINED_VARIABLE_MESSAGES)) {
            return new errors_1.UndefinedVariable(identifier, astCreator_1.locationDummyNode(line, column, source));
        }
        else {
