...
function preparePrelude(context) {
    ...
    const program = parser_1.parse(prelude, context);
    if (program === null) {
        return undefined;
    }
    return program.body;
...
function fullJSRunner(program, context, options = {}) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const preludeAndBuiltins = containsPrevEval(context)
            ? []
            : [...transpiler_1.getBuiltins(context.nativeStorage), ...prelude];
        // modules
        hoistAndMergeImports_1.hoistAndMergeImports(program);
        ...
        const preEvalCode = astring_1.generate(preEvalProgram);
        ...
        try {
            ...
            context.errors.push(error instanceof runtimeSourceError_1.RuntimeSourceError ? error : yield errors_1.toSourceError(error, sourceMapJson));
            return utils_1.resolvedErrorPromise;
        }
    });
}
