...
const errors_2 = require("../../parser/errors");
...
const JAVASCRIPT_CODE_SNIPPETS_ERRORS = [
    {
        ...
        snippet: `
          ...
          `,
        value: undefined,
        errors: [new errors_1.UndefinedVariable('b', astCreator_1.locationDummyNode(2, 20, 'source'))]
    },
    {
        name: 'SYNTAX ERROR',
        snippet: `function(){}`,
        value: undefined,
        errors: [
            new errors_2.FatalSyntaxError({ start: { line: 1, column: 8 }, end: { line: 1, column: 9 }, source: undefined }, 'SyntaxError: Unexpected token (1:8)')
        ]
    },
    {
        ...
        snippet: `
            ...
            `,
        value: undefined,
        errors: [new errors_1.UndefinedVariable('g', astCreator_1.locationDummyNode(3, 14, 'source'))]
    }
];
// FullJS Unit Tests
test('Source builtins are accessible in fullJS program', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    `;
    const fullJSContext = context_1.mockContext(types_1.Chapter.FULL_JS, types_1.Variant.DEFAULT);
...
describe('Additional JavaScript features are not available in Source Native', () => {
    it.each([...JAVASCRIPT_CODE_SNIPPETS_NO_ERRORS])(`%p`, ({ snippet }) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        for (let chapterNum = 0; chapterNum <= 4; chapterNum++) {
            const sourceNativeContext = context_1.mockContext(chapterNum, types_1.Variant.NATIVE);
...
test('Error handling script is injected in HTML code', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const htmlContext = context_1.mockContext(types_1.Chapter.HTML, types_1.Variant.DEFAULT);
    const result = yield __1.runInContext(htmlDocument, htmlContext);
    expect(result.status).toStrictEqual('finished');
