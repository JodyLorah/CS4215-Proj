...
let context = context_1.mockContext(types_1.Chapter.SOURCE_1, types_1.Variant.TYPED);
beforeEach(() => {
    context = context_1.mockContext(types_1.Chapter.SOURCE_1, types_1.Variant.TYPED);
});
describe('basic types', () => {
    ...
    `;
        parser_1.parse(code, context);
        expect(__1.parseError(context.errors)).toMatchInlineSnapshot(`"Line 2: Type 'number' is not callable."`);
    });
...
describe('union types', () => {
    ...
    `;
        parser_1.parse(code, context);
        expect(__1.parseError(context.errors)).toMatchInlineSnapshot(`"Line 6: Type 'boolean' is not assignable to type 'string | number'."`);
    });
...
describe('function types', () => {
    ...
    `;
        parser_1.parse(code, context);
        expect(__1.parseError(context.errors)).toMatchInlineSnapshot(`"Line 3: Type '(boolean, boolean) => number | string' is not assignable to type '(number | string, number | string) => number | string'."`);
    });
...
describe('type aliases', () => {
    ...
    `;
        parser_1.parse(code, context);
        expect(__1.parseError(context.errors)).toMatchInlineSnapshot(`"Line 3: Type alias declarations may only appear at the top level"`);
    });
    ...
    `;
        parser_1.parse(code, context);
        expect(__1.parseError(context.errors)).toMatchInlineSnapshot(`"Line 2: Name x not declared."`);
    });
    ...
    `;
        parser_1.parse(code, context);
        expect(__1.parseError(context.errors)).toMatchInlineSnapshot(`"Line 1: Type 'boolean' is not assignable to type 'TestType'."`);
    });
    it('should throw errors for undeclared types', () => {
        const code = `const x: x = 1;`;
        parser_1.parse(code, context);
        expect(__1.parseError(context.errors)).toMatchInlineSnapshot(`"Line 1: Type 'x' not declared."`);
    });
    ...
    `;
        parser_1.parse(code, context);
        expect(__1.parseError(context.errors)).toMatchInlineSnapshot(`"Line 2: SyntaxError: Identifier 'x' has already been declared. (2:11)"`);
    });
...
describe('generic types', () => {
    ...
    `;
        parser_1.parse(code, context);
        expect(__1.parseError(context.errors)).toMatchInlineSnapshot(`"Line 2: Type 'NotGeneric' is not generic."`);
    });
    ...
    `;
        parser_1.parse(code, context);
        expect(__1.parseError(context.errors)).toMatchInlineSnapshot(`"Line 1: Type 'boolean' is not assignable to type 'Union<string, number>'."`);
    });
});
...
describe('unary operations', () => {
    ...
    `;
        parser_1.parse(code, context);
        expect(__1.parseError(context.errors)).toMatchInlineSnapshot(`"Line 9: Type 'string' is not assignable to type 'boolean'."`);
    });
});
...
describe('conditional expressions', () => {
    ...
    `;
        parser_1.parse(code, context);
        expect(__1.parseError(context.errors)).toMatchInlineSnapshot(`"Line 6: Type 'boolean | string' is not assignable to type 'number'."`);
    });
});
describe('if-else statements', () => {
    ...
    `;
        parser_1.parse(code, context);
        expect(__1.parseError(context.errors)).toMatchInlineSnapshot(`"Line 13: Type 'string' is not assignable to type 'number'."`);
    });
});
describe('import statements', () => {
    ...
    `;
        parser_1.parse(code, context);
        expect(__1.parseError(context.errors)).toMatchInlineSnapshot(`"Line 3: SyntaxError: 'import' and 'export' may only appear at the top level (3:8)"`);
    });
