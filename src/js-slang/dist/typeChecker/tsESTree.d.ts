...
export declare type Node = NodeMap[keyof NodeMap];
...
declare type Expression = ExpressionMap[keyof ExpressionMap];
export declare type BaseExpression = BaseNode;
declare type ChainElement = SimpleCallExpression | MemberExpression;
...
export declare type Literal = SimpleLiteral | RegExpLiteral | BigIntLiteral;
...
export declare type TSTypeAnnotationType = 'TSTypeAnnotation' | 'TSFunctionType' | 'TSUnionType' | 'TSIntersectionType' | 'TSLiteralType' | 'TSArrayType' | 'TSParenthesizedType';
export declare type TSTypeKeyword = 'TSAnyKeyword' | 'TSBigIntKeyword' | 'TSBooleanKeyword' | 'TSNeverKeyword' | 'TSNullKeyword' | 'TSNumberKeyword' | 'TSObjectKeyword' | 'TSStringKeyword' | 'TSSymbolKeyword' | 'TSUndefinedKeyword' | 'TSUnknownKeyword' | 'TSVoidKeyword';
export declare type TSOnlyNode = 'TSTypeAliasDeclaration' | 'TSAsExpression' | 'TSInterfaceDeclaration' | 'TSTypeReference';
export declare type TSNode = TSTypeAnnotation | TSFunctionType | TSUnionType | TSIntersectionType | TSTypeAliasDeclaration | TSInterfaceDeclaration | TSAsExpression | TSTypeReference;
export declare type TSType = TSKeywordType | TSFunctionType | TSUnionType | TSIntersectionType | TSTypeReference | TSLiteralType | TSArrayType | TSParenthesizedType;
declare type BaseTSNode = BaseNode;
