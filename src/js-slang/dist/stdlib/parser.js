...
const transformers = new Map([
        ...
        (node) => {
            ...
            return list_1.vector_to_list([
                ...
                node.key.type === 'Identifier'
                    ? list_1.vector_to_list(['property', node.key.name])
                    : transform(node.key),
    ...
    [
        ...
        (_node) => {
            return list_1.vector_to_list(['default']);
        }
    ],
    [
    ...
    [
        ...
        (node) => {
            return list_1.vector_to_list(['export_default_declaration', transform(node.declaration)]);
        }
    ],
    [
        'ExportSpecifier',
        (node) => {
            return list_1.vector_to_list(['name', node.exported.name]);
        }
    ],
    [
        'ClassDeclaration',
