...
function findIdentifierNode(root, context, loc) {
    ...
    const found = walkers_1.findNodeAt(root, undefined, undefined, findByLocationPredicate, customWalker);
...
function findDeclarationNode(program, identifier) {
    ...
    for (const root of ancestors) {
        walkers_1.recursive(root, undefined, {
