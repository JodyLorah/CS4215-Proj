...
export declare type ExecutionMethod = 'native' | 'interpreter' | 'auto' | 'ec-evaluator';
...
export declare type Result = Suspended | SuspendedNonDet | Finished | Error | SuspendedEcEval;
