...
export declare function expectDisplayResult(code: string, options?: TestOptions): any;
export declare function expectVisualiseListResult(code: string, options?: TestOptions): any;
export declare function getDisplayResult(code: string, options?: TestOptions): Promise<string[]>;
export declare function expectResult(code: string, options?: TestOptions): any;
export declare function expectParsedErrorNoErrorSnapshot(code: string, options?: TestOptions): any;
export declare function expectParsedError(code: string, options?: TestOptions): any;
export declare function expectDifferentParsedErrors(code1: string, code2: string, options?: TestOptions): any;
export declare function expectWarning(code: string, options?: TestOptions): any;
export declare function expectParsedErrorNoSnapshot(code: string, options?: TestOptions): any;
export declare function expectToMatchJS(code: string, options?: TestOptions): Promise<any>;
export declare function expectToLooselyMatchJS(code: string, options?: TestOptions): Promise<any>;
