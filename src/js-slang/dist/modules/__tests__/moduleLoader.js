...
describe('Testing modules/moduleLoader.ts in a jsdom environment', () => {
    ...
    test('Loading a module bundle correctly', () => {
        ...
        const loadedBundle = moduleLoader.loadModuleBundle('module', createContext_1.createEmptyContext(1, types_1.Variant.DEFAULT, []));
    ...
    test('Loading a wrongly implemented module bundle throws ModuleInternalError', () => {
        ...
        expect(() => moduleLoader.loadModuleBundle('module', createContext_1.createEmptyContext(1, types_1.Variant.DEFAULT, []))).toThrow(moduleErrors_1.ModuleInternalError);
    });
