...
import { Context, NativeStorage } from '../types';
/**
 ...
 */
declare const globalIdNames: readonly ["native", "callIfFuncAndRightArgs", "boolOrErr", "wrap", "unaryOp", "binaryOp", "throwIfTimeout", "setProp", "getProp", "builtins"];
export declare type NativeIds = Record<typeof globalIdNames[number], es.Identifier>;
export declare function transformImportDeclarations(program: es.Program, usedIdentifiers: Set<string>, useThis?: boolean): [string, es.VariableDeclaration[], es.Program['body']];
...
export declare type TranspiledResult = {
    transpiled: string;
