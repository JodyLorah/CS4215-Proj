...
export declare const ensureGlobalEnvironmentExist: (context: Context<any>) => void;
export declare const defineSymbol: (context: Context<any>, name: string, value: any) => void;
...
export declare const importExternalSymbols: (context: Context<any>, externalSymbols: string[]) => void;
/**
 * Imports builtins from standard and external libraries.
 */
export declare const importBuiltins: (context: Context<any>, externalBuiltIns: CustomBuiltIns) => void;
declare const createContext: <T>(chapter?: Chapter, variant?: Variant, externalSymbols?: string[], externalContext?: T | undefined, externalBuiltIns?: CustomBuiltIns) => Context<any>;
