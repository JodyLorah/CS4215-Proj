 ...
 * @returns
 */
export declare const createAcornParserOptions: (ecmaVersion: ecmaVersion, errors?: SourceError[] | undefined, options?: Partial<import("acorn").Options> | undefined, throwOnError?: boolean | undefined) => import("acorn").Options;
/**
 ...
 */
export declare const positionToSourceLocation: (position: Position, source?: string | undefined) => SourceLocation;
