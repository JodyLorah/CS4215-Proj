...
test('Test that builtins are prompted', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const line = 1;
    const col = 1;
    const [extractedNames] = yield index_1.getNames(code, line, col, __1.createContext(types_1.Chapter.SOURCE_4));
    const expectedNames = [
...
test('Test that unavailable builtins are not prompted', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const line = 1;
    const col = 1;
    const [extractedNames] = yield index_1.getNames(code, line, col, __1.createContext(types_1.Chapter.SOURCE_1));
    const expectedNames = [
        { name: 'function', meta: 'keyword', score: 20000 },
        { name: 'const', meta: 'keyword', score: 20000 },
        { name: 'if', meta: 'keyword', score: 20000 },
